  ...
  return (
    <div className="dashboard w-full">
      ...
      <div className="flex flex-col items-center">
        <h1 className="text-4xl text-slate-700 font-bold mb-20">
        ...
        <div className="dashboard-menu w-full max-w-3xl p-4 ">
          ...
          <div className="flex gap-4  p-2 mb-4">
            ...
            <div className="box w-2/3">
              <h1 className="text-slate-700 text-xl mb-3 font-semibold cursor-pointer">
          ...
          <div className="flex gap-4  p-2 mb-4">
            ...
            <div className="box w-2/3">
              <h1 className="text-slate-700 text-xl mb-3 font-semibold">
                Add classes
              </h1>
              <p className="text-sm text-slate-700">
                Create rich course content and coaching products for your
